...
# This file is generated by device/samsung/j2xlte/setup-makefiles.sh
...
PRODUCT_COPY_FILES += \
    ...
    vendor/samsung/j2xlte/proprietary/bin/bootchecker:system/bin/bootchecker \
    vendor/samsung/j2xlte/proprietary/bin/ext_symlink.sh:system/bin/ext_symlink.sh \
    vendor/samsung/j2xlte/proprietary/bin/ext_data.sh:system/bin/ext_data.sh \
    vendor/samsung/j2xlte/proprietary/bin/ext_kill.sh:system/bin/ext_kill.sh \
    vendor/samsung/j2xlte/proprietary/bin/inputfreq.sh:system/bin/inputfreq.sh \
    vendor/samsung/j2xlte/proprietary/bin/recoveryfreq.sh:system/bin/recoveryfreq.sh \
    vendor/samsung/j2xlte/proprietary/bin/IPSecService:system/bin/IPSecService \
    vendor/samsung/j2xlte/proprietary/bin/ddexe:system/bin/ddexe \
    ...
    vendor/samsung/j2xlte/proprietary/etc/plmn_delta.bin:system/etc/plmn_delta.bin \
    vendor/samsung/j2xlte/proprietary/etc/plmn_se13.bin:system/etc/plmn_se13.bin \
    vendor/samsung/j2xlte/proprietary/etc/connectivity_calibration.ini:system/etc/connectivity_calibration.ini \
    ...
    vendor/samsung/j2xlte/proprietary/etc/spn-conf.xml:system/etc/spn-conf.xml \
    vendor/samsung/j2xlte/proprietary/etc/thermalSensorsConfig.xml:system/etc/thermalSensorsConfig.xml \
    vendor/samsung/j2xlte/proprietary/etc/.omxregister:system/etc/.omxregister \
    vendor/samsung/j2xlte/proprietary/etc/somxreg.conf:system/etc/somxreg.conf \
    ...
    vendor/samsung/j2xlte/proprietary/lib/lib_SA_GoogleFX_ver119k.so:system/lib/lib_SA_GoogleFX_ver119k.so \
    vendor/samsung/j2xlte/proprietary/lib/lib_SamsungRec_V04013.so:system/lib/lib_SamsungRec_V04013.so \
    vendor/samsung/j2xlte/proprietary/lib/lib_Samsung_AudioZoom_v102.so:system/lib/lib_Samsung_AudioZoom_v102.so \
    vendor/samsung/j2xlte/proprietary/lib/lib_Samsung_Resampler.so:system/lib/lib_Samsung_Resampler.so \
    vendor/samsung/j2xlte/proprietary/lib/lib_DNSe_EP_ver216c.so:system/lib/lib_DNSe_EP_ver216c.so \
    vendor/samsung/j2xlte/proprietary/lib/lib_SoundAlive_3DPosition_ver107.so:system/lib/lib_SoundAlive_3DPosition_ver107.so \
    vendor/samsung/j2xlte/proprietary/lib/lib_SoundAlive_SRC192_ver205.so:system/lib/lib_SoundAlive_SRC192_ver205.so \
    vendor/samsung/j2xlte/proprietary/lib/lib_SoundAlive_play_plus_ver126a.so:system/lib/lib_SoundAlive_play_plus_ver126a.so \
    vendor/samsung/j2xlte/proprietary/lib/lib_SoundAlive_ver118t.so:system/lib/lib_SoundAlive_ver118t.so \
    vendor/samsung/j2xlte/proprietary/lib/libSoundAlive_VSP_ver315b_arm.so:system/lib/libSoundAlive_VSP_ver315b_arm.so \
    vendor/samsung/j2xlte/proprietary/lib/lib_soundaliveresampler.so:system/lib/lib_soundaliveresampler.so \
    vendor/samsung/j2xlte/proprietary/lib/libsamsungRecord.so:system/lib/libsamsungRecord.so \
    vendor/samsung/j2xlte/proprietary/lib/libsamsungRecord_zoom.so:system/lib/libsamsungRecord_zoom.so \
    ...
    vendor/samsung/j2xlte/proprietary/lib/soundfx/libaudiosa_sec.so:system/lib/soundfx/libaudiosa_sec.so \
    vendor/samsung/j2xlte/proprietary/lib/soundfx/libmyspace.so:system/lib/soundfx/libmyspace.so \
    vendor/samsung/j2xlte/proprietary/lib/modules/pskey_bt.txt:system/lib/modules/pskey_bt.txt \
    vendor/samsung/j2xlte/proprietary/lib/libsdp_crypto.so:system/lib/libsdp_crypto.so \
    vendor/samsung/j2xlte/proprietary/lib/libsec_devenc.so:system/lib/libsec_devenc.so \
    vendor/samsung/j2xlte/proprietary/lib/libsAMRNB.so:system/lib/libsAMRNB.so \
    vendor/samsung/j2xlte/proprietary/lib/libsAMRWB.so:system/lib/libsAMRWB.so \
    vendor/samsung/j2xlte/proprietary/lib/libsaiv_codec.so:system/lib/libsaiv_codec.so \
    vendor/samsung/j2xlte/proprietary/lib/libsomp.so:system/lib/libsomp.so \
    vendor/samsung/j2xlte/proprietary/lib/libsoundalive.so:system/lib/libsoundalive.so \
    vendor/samsung/j2xlte/proprietary/lib/libsoundspeed.so:system/lib/libsoundspeed.so \
    vendor/samsung/j2xlte/proprietary/lib/libsprdftms.so:system/lib/libsprdftms.so \
    vendor/samsung/j2xlte/proprietary/lib/libspdkeygen.so:system/lib/libspdkeygen.so \
    vendor/samsung/j2xlte/proprietary/lib/libsetproperty.so:system/lib/libsetproperty.so \
    vendor/samsung/j2xlte/proprietary/lib/libsfextaac.so:system/lib/libsfextaac.so \
    vendor/samsung/j2xlte/proprietary/lib/libsfextavi.so:system/lib/libsfextavi.so \
    vendor/samsung/j2xlte/proprietary/lib/libsfextcmn.so:system/lib/libsfextcmn.so \
    vendor/samsung/j2xlte/proprietary/lib/libsfextcp.so:system/lib/libsfextcp.so \
    vendor/samsung/j2xlte/proprietary/lib/libsfextflac.so:system/lib/libsfextflac.so \
    vendor/samsung/j2xlte/proprietary/lib/libsfextflv.so:system/lib/libsfextflv.so \
    vendor/samsung/j2xlte/proprietary/lib/libsfextmkv.so:system/lib/libsfextmkv.so \
    vendor/samsung/j2xlte/proprietary/lib/libsfextmp4f.so:system/lib/libsfextmp4f.so \
    vendor/samsung/j2xlte/proprietary/lib/libsfextrmf.so:system/lib/libsfextrmf.so \
